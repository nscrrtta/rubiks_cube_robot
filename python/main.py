#!/usr/bin/python3
from constants import png_path, opposite_faces
...
FRU_png = pygame.image.load(f'{png_path}/FRU.png')
LBD_png = pygame.image.load(f'{png_path}/LBD.png')
red_x   = pygame.image.load(f'{png_path}/red_x.png')
...
while running:
    ...
    if cube.moves and not cancel:
        ...
        if cube.moves and cube.moves[0][0] == opposite_faces[curr_move[0]]:
